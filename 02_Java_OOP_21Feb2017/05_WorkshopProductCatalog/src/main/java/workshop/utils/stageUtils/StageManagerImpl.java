package workshop.utils.stageUtils;

import workshop.constants.AppConstants;
import workshop.utils.screenUtils.Dimensions;
import workshop.utils.screenUtils.UIDimensions;
...
public class StageManagerImpl extends Stage implements StageManager {
    ...
    public FXMLLoader loadSceneToStage(Stage currentStage, String fxmlPath, Modality modality) {
        ...
        try {
            ...
            currentStage.setTitle(AppConstants.TITLE);
